...
export function Footer({ logo, brandName }: FooterProps) {
  ...
  return (
    <footer className="pb-6 pt-16 lg:pb-8 px-4 lg:pt-24 bg-footer border-t border-gray-500 dark:border-gray-600">
      <div className="container mx-auto lg:px-8">
        <div className="md:flex md:items-end md:justify-between">
          <Link href="/" className="flex items-center gap-x-2" aria-label={brandName || t('goToHomepage')}>
            {logo}
        ...
        <div className="border-t border-gray-500 dark:border-gray-600 mt-6 pt-6 md:mt-8 md:pt-8 lg:grid lg:grid-cols-10 lg:gap-8">
